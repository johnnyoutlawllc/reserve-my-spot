    ...
    <main className="mx-auto max-w-5xl px-5 pb-20 pt-12 sm:pt-20">
      <header className="max-w-2xl">
        ...
        <p className="mt-4 text-[15px] leading-relaxed text-muted">
          Premium spa members claim a spot before they leave the house. The front desk sees the request the
          instant it lands, along with the member’s live driving ETA — so a spot gets held for someone who is
          genuinely on the way, and released when they aren’t.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-faint">
          Replaces the drive-over-and-hope model: no lobby, no clipboard, no guessing how long the wait is.
        </p>
      </header>
